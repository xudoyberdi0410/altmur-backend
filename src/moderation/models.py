...
class Ban(Base):
    ...
    banned_user_id: Mapped[int] = mapped_column(ForeignKey("users.user_id"), nullable=False)
    banned_by_user_id: Mapped[int] = mapped_column(ForeignKey("users.user_id"), nullable=False)
